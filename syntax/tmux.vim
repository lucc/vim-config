...
syn keyword tmuxOptsSet
	...
	\ display-panes-colour display-panes-active-colour display-panes-time display-time history-limit
	\ lock-after-time lock-command lock-server message-attr message-command-attr
	\ message-command-bg message-bg message-command-fg message-fg message-limit
	\ mouse-resize-pane mouse-select-pane mouse-select-window mouse-utf8
	\ pane-active-border-bg pane-border-bg pane-active-border-fg pane-border-fg prefix prefix2
...
syn keyword tmuxOptsSetw
	...
	\ window-status-current-attr window-status-attr window-status-current-bg window-status-bg
	\ window-status-current-fg window-status-current-format
	\ window-status-fg window-status-format
